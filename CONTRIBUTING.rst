...
If you experience bugs or general issues with ``birdears``, please have a look
...
You can help improve ``birdears`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``birdears`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``birdears``'s files. While this mechanism can
...
#. Install |pre-commit|_::
   ...
   ``birdears`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/birdears
.. _issue tracker: https://github.com/<USERNAME>/birdears/issues
.. <-- end -->
