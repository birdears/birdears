...
coverage run --source=birdears --omit=birdears/urwid/**,birdears/click/**,birdears/toml/**,birdears/interfaces/gui/** --module pytest --verbose tests/
coverage html --omit='*birdears/urwid/*','*birdears/click/*','*birdears/toml/*','*birdears/interfaces/gui/*' -d docs/coverage-html/
